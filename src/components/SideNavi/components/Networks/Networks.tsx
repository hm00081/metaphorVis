...
interface Props {
  ...
  setClickedCluster: React.Dispatch<
    React.SetStateAction<SankeyData | undefined>
  >;
}
      ...
      <div className={style.categoryWrapper}>
        <svg width="25" height="25" style={{ marginLeft: '7px' }}>
          <rect
            width="15"
            height="15"
            style={{ fill: '#ff00ff', paddingRight: '10em' }}
          ></rect>
        </svg>
        <div
          style={{
        ...
        <svg width="25" height="25" style={{ marginLeft: '7px' }}>
          <rect
            width="15"
            height="15"
            style={{ fill: '#0280ff', paddingRight: '20px' }}
          ></rect>
        </svg>
        <div style={{ fontSize: '13px', fontWeight: '630', marginTop: '-5px' }}>
          Representation
        </div>
      </div>
      <svg
      ...
      >
        <switch>
          ...
          <g>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 707.6112 789.4521)"
                className={style.nodeText}
              >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 447.1541 633.9375)"
                className={style.nodeText}
              >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 629.2255 551.7305)"
                className={style.nodeText}
              >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 1144.7137 348.7222)"
                className={style.nodeText}
              >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 1076.5907 401.4106)"
                className={style.nodeText}
              >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 684.5321 589.4287)"
                className={style.nodeText}
              >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 790.2157 746.9717)"
                className={style.nodeText}
              >
            ...
            <text
              transform="matrix(1 0 0 1 440.0565 912.0576)"
              className={style.nodeText}
            >
              opinion summarization
            </text>
            <text
              transform="matrix(1 0 0 1 36.4681 632.7715)"
              className={style.nodeText}
            >
              emotion cause detection
            </text>
            <text
              transform="matrix(1 0 0 1 250.9061 416.7632)"
              className={style.nodeText}
            >
              timeline analysis
            </text>
            <text
              transform="matrix(1 0 0 1 716.12 331.1958)"
              className={style.nodeText}
            >
              polarity classfication
            </text>
            <text
              transform="matrix(1 0 0 1 380.4676 1016.584)"
              className={style.nodeText}
            >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 484.4012 1072.2305)"
                className={style.nodeText}
              >
                software
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 196.1244 917.04)"
                className={style.nodeText}
              >
                toy&instrument
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 385.3133 691.4326)"
                className={style.nodeText}
              >
                map
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 505.9696 521.853)"
                className={style.nodeText}
              >
                pattern
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 381.742 567.4912)"
                className={style.nodeText}
              >
                geometry
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 173.6322 550.709)"
                className={style.nodeText}
              >
                plant
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 228.6341 578.6826)"
                className={style.nodeText}
              >
                landscape
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 94.5946 382.6704)"
                className={style.nodeText}
              >
                nonmetal
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 71.9984 443.2769)"
                className={style.nodeText}
              >
                space time movement
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 135.6288 483.0864)"
                className={style.nodeText}
              >
                natural phenomena
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 162.1659 335.1362)"
                className={style.nodeText}
              >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 476.036 402.6733)"
                className={style.nodeText}
              >
                machine
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 807.0028 81.353)"
                className={style.nodeText}
              >
                cell
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 676.4071 29.9067)"
                className={style.nodeText}
              >
                food
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 511.953 55.8491)"
                className={style.nodeText}
              >
                celestial
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 1173.3231 291.8794)"
                className={style.nodeText}
              >
                fiber
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 1070.8094 301.3345)"
                className={style.nodeText}
              >
                picture
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 992.3055 353.936)"
                className={style.nodeText}
              >
                animal
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 377.4452 357.3325)"
                className={style.nodeText}
              >
                metal
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 334.5907 235.2935)"
                className={style.nodeText}
              >
                behavior
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 214.8138 283.6343)"
                className={style.nodeText}
              >
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 599.1473 737.9033)"
                className={style.nodeText}
              >
                compound
              </text>
            ...
            <g>
              <text
                transform="matrix(1 0 0 1 739.538 699.3584)"
                className={style.nodeText}
              >
                building&structure
              </text>
            ...
            <text
              transform="matrix(1 0 0 1 208.3363 777.6445)"
              className={style.nodeText}
            >
              multilingual / crosslingual sentiment analysis
            </text>
            <text
              transform="matrix(1 0 0 1 354.9989 471.7856)"
              className={style.nodeText}
            >
              easy exploration of sentiment information
            </text>
            <text
              transform="matrix(1 0 0 1 567.4032 215.4429)"
              className={style.nodeText}
            >
              sentiment information description a multi-aspect
            </text>
            <text
              transform="matrix(1 0 0 1 649.5868 128.4897)"
              className={style.nodeText}
            >
              aspect based sentiment analysis
            </text>
            <text
              transform="matrix(1 0 0 1 507.4823 706.4688)"
              className={style.nodeText}
            >
              letter
            </text>
            ...
            >
              <title>
                finding significant person/opinions/fact/stance/attitude
              </title>
            </rect>
            <rect
              x="412.6"
