...
function TargetCloudResults() {
    ...
    function targetClouds() {
        let targetClouds = [];
        for (let i = 0; i < 1; i++) {
            targetClouds.push(<WordCloud data={RiverWord.TAR} {...wordCloudConfig} />);
        }
        return targetClouds;
    }
            ...
            <div className="flex w-screen h-screen">
                <div className="w-10/12 text-sm h-screen">
                    ...
                    <div className="flex flex-row flex-grow h-9/10">
                        ...
                        <div className="">{targetClouds()}</div>
                        {/* <div>{interClouds()}</div>
                        <div>{repClouds()}</div>
                        <div>{varClouds()}</div>
                        <div>{techClouds()}</div> */}
...
export default TargetCloudResults;
